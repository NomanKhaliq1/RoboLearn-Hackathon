      ...
      try {
        ...
        if (user) {
          ...
          if (verifiedUser) {
            ...
            // Timeout occurred or getMe returned null
            console.warn("Auth check timed out or failed, defaulting to guest mode");
            setCurrentUser(null);
          }
        } else {
          setCurrentUser(null);
        ...
        console.warn("Auth check failed, defaulting to guest mode:", error);
        setCurrentUser(null);
      } finally {
        setIsLoading(false);
      }
